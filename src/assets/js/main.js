...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const menuToggleText = menuToggle.querySelector("p");
    ...
    menuToggle.addEventListener("click", () => {
        ...
        if (isMenuOpen) {
            ...
            menuToggleText.textContent = "Menu"; // can show 2
        }
    });
    ...
    loader.load(config.modelPath, (gltf) => {
        ...
        model.rotation.set(config.baseRotationX, config.baseRotationY, config.baseRotationZ);
